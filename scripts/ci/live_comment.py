...
def run(
    ...
    while True:
        ...
        body = build_comment_body(
            ...
            lockfile_changed, lockfile_diff, timings_status,
        )
...
def main() -> int:
    ...
    # Structured review statuses from workflow_call jobs (review-labels, etc.)
    review_statuses_json = os.environ.get("REVIEW_STATUSES", "")
